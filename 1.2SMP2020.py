...
# 调用XLNet模型，同时因为本任务的情感分类是6类，设置num_classes = 6
model = XLNetForSequenceClassification.from_pretrained('xlnet-large-cased', num_classes=6, ignore_mismatched_sizes=True)
