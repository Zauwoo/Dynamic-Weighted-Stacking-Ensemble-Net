...
# 调用华为的NeZha模型，同时因为本任务的情感分类是2类，设置num_classes = 2
model = NeZhaForSequenceClassification.from_pretrained('nezha-large-wwm-chinese', num_classes=2)
tokenizer = NeZhaTokenizer.from_pretrained('nezha-large-wwm-chinese')
...
dev_ds = EmotionData('../Nezhamix/dev.tsv')
